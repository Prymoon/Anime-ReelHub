...
<body class="category-page game-page">
    ...
    <!-- Main Content -->
    <div class="container">
        <h1 class="main-title">Game Collection</h1>
        
        <div class="video-grid" id="gameVideoGrid">
            ...
            <?php else: ?>
                <div class="no-videos">
                    <p>No game videos available yet. Please check back later or visit the admin panel to upload some!</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
